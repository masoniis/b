use crate::{
    ...
    render_world::{
        ...
        passes::{
            ...
            main_camera_centric::{
                opaque_pass::startup::DEPTH_FORMAT,
                shared::{CentralCameraViewBindGroupLayout, EnvironmentBindGroupLayout},
            },
        },
        types::Vertex,
    },
...
pub fn setup_bb_pipeline_and_buffers(
    ...
    let wireframe_pipeline_def = PipelineDefinition {
        ...
        material_path: "assets/shaders/camera_centric/wireframe/main.material.ron",
