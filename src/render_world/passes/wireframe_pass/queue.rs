...
use crate::render_world::passes::opaque_pass::extract::RenderTransformComponent;
use crate::render_world::passes::wireframe_pass::startup::setup_wireframe_pipeline::{
...
pub fn queue_wireframe_system(
    ...
    if wireframe_buffer.buffer.size() < buffer_size {
        ...
        wireframe_buffer.bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            layout: &wireframe_pipeline.inner.get_layout(1),
