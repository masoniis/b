...
use crate::render_world::passes::world::shadow_pass::extract::sun_extractor::ExtractedSun;
...
#[instrument(skip_all)]
pub fn update_environment_buffer_system(
    // Input (target buffer)
    ...
    let skybox_params =
        EnvironmentData::new(extracted_sun.direction, [0.08, 0.12, 0.45], [0.3, 0.5, 0.8]);
